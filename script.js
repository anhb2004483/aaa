...
const sn1Refs = {
    ...
    bbb: document.getElementById('sn1-bbb-data')
};
const sn2Refs = {
    ...
    bbb: document.getElementById('sn2-bbb-data')
};
const sn3Refs = {
    ...
    bbb: document.getElementById('sn3-bbb-data')
};
const sn4Refs = {
    ...
    bbb: document.getElementById('sn4-bbb-data')
};
...
const fetchDataForSensor = (sensorRef, refs) => {
    ...
    onValue(ref(database, `${sensorRef}/bbb`), (snapshot) => {
        refs.bbb.textContent = snapshot.val() || 'N/A';
    });
};
